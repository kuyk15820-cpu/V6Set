...
$(APPLICATION_NAME)_FILES += $(wildcard PartyUIView/*.mm)

$(APPLICATION_NAME)_FILES += $(wildcard SettingsView/*.mm)
...
$(APPLICATION_NAME)_CFLAGS += -Iheaders -Isources -IENCRYPT -IHUD -ILottieB64 -IPartyUIView -ISettingsView -F./deps -I./deps/ffmpegkit.framework/Headers
